...
#define MAXIMUM_SEQUENCER_TRACK_LAYERS 16
#define MAXIMUM_SEQUENCER_PATTERNS 16
#define MAXIMUM_SEQUENCER_BANKS 16
#define MAXIMUM_RATCHET_STEPS 16
...
#define MAXIMUM_DEXED_SYNTH_SOUNDS 8
#define MAXIMUM_BRAIDS_SYNTH_SOUNDS 1
#define MAXIMUM_FM_DRUM_SOUNDS 3
#define MAXIMUM_DELAY_INSTANCES 1
#define MAXIMUM_MIDI_SOUNDS 16
#define MAXIMUM_CV_GATE_SOUNDS 4
#define MAXIMUM_CV_TRIG_SOUNDS 16

#define MAXIMUM_PATTERN_FX_PARAM_PAGES 4
#define MAXIMUM_PATTERN_FX_PARAMS 4
#define MAXIMUM_PATTERN_PAGES 2

#define MAXIMUM_CHOKE_SOURCES 8
