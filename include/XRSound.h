...
namespace XRSound
{
    ...
    */
    ...
    // extern globals
    extern SOUND activePatternSounds[MAXIMUM_SEQUENCER_TRACKS];
    ...
    extern float compAtt;
    extern float compRel;
    extern float compRat;
    extern float compThr;
    extern float compKnee;
    extern float compMkup;
    extern uint8_t compDsmp;

    extern const std::string patternPageNames[4];

    extern const std::map<SOUND_TYPE, int8_t> soundTypeInstanceLimitMap;
    ...
    extern const std::map<SOUND_TYPE, const int32_t*> soundTypeInitParams;
    extern const std::map<SOUND_TYPE, int> soundPageNumMap;
    extern const std::map<SOUND_TYPE, std::map<int, std::string>> soundCurrPageNameMap;
