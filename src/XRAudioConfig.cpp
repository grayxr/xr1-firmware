...
AudioSynthDexed          dexed1(1, SAMPLE_RATE);         //xy=1029.750015258789,391.5000057220459
AudioEffectEnvelope      venv5; //xy=1026.5,1300
AudioSynthDexed          dexed3(1, SAMPLE_RATE); //xy=1029.500015258789,904.2500133514404
AudioEffectEnvelope      venv7; //xy=1026.6666259765625,1666.6666259765625
AudioEffectEnvelope      venv6; //xy=1030,1490
AudioSynthDexed          dexed2(1, SAMPLE_RATE); //xy=1034.2500343322754,644.7500195503235
AudioSynthDexed          dexed4(1, SAMPLE_RATE); //xy=1032.7500343322754,1152.5000343322754
...
AudioAmplifier           dright3; //xy=1176.2500190734863,920.0000133514404
AudioAmplifier           vleft3;         //xy=1177,772
AudioAmplifier           vleft8; //xy=1172.9999389648438,1848.6666259765625
AudioAmplifier           dleft3; //xy=1177.5000190734863,878.7500128746033
AudioAmplifier           vleft2;         //xy=1179,512
AudioAmplifier           vleft4;         //xy=1177,1022
AudioAmplifier           vright3;        //xy=1178,811
AudioAmplifier           dright2; //xy=1178.7500190734863,657.5000104904175
AudioAmplifier           vleft1;         //xy=1181,263
AudioAmplifier           dright4; //xy=1177.5000190734863,1167.5000176429749
AudioAmplifier           vright2;        //xy=1180,551
AudioAmplifier           vright4;        //xy=1178,1060
AudioAmplifier           dleft2; //xy=1180.0000190734863,616.2500100135803
AudioAmplifier           vright8; //xy=1174.9999389648438,1887.6666259765625
AudioAmplifier           dleft4; //xy=1178.7500190734863,1126.2500171661377
...
AudioAmplifier           dright1;           //xy=1185.0000190734863,406.2500057220459
AudioAmplifier           vright5; //xy=1181.5,1321
AudioAmplifier           dleft1;           //xy=1186.2500190734863,365.00000524520874
...
AudioConnection          patchCord63(dexed1, 0, dleft1, 0);
AudioConnection          patchCord64(dexed1, 0, dright1, 0);
AudioConnection          patchCord65(venv5, vleft5);
AudioConnection          patchCord66(venv5, vright5);
AudioConnection          patchCord67(dexed3, 0, dleft3, 0);
AudioConnection          patchCord68(dexed3, 0, dright3, 0);
AudioConnection          patchCord69(venv7, vleft7);
AudioConnection          patchCord70(venv7, vright7);
AudioConnection          patchCord71(venv6, vleft6);
AudioConnection          patchCord72(venv6, vright6);
AudioConnection          patchCord73(dexed2, 0, dleft2, 0);
AudioConnection          patchCord74(dexed2, 0, dright2, 0);
AudioConnection          patchCord75(dexed4, 0, dleft4, 0);
AudioConnection          patchCord76(dexed4, 0, dright4, 0);
AudioConnection          patchCord77(venv16, vleft16);
AudioConnection          patchCord78(venv16, vright16);
AudioConnection          patchCord79(venv13, vleft13);
AudioConnection          patchCord80(venv13, vright13);
AudioConnection          patchCord81(venv15, vleft15);
AudioConnection          patchCord82(venv15, vright15);
AudioConnection          patchCord83(venv14, vleft14);
AudioConnection          patchCord84(venv14, vright14);
AudioConnection          patchCord85(venv12, vleft12);
AudioConnection          patchCord86(venv12, vright12);
AudioConnection          patchCord87(venv9, vleft9);
AudioConnection          patchCord88(venv9, vright9);
AudioConnection          patchCord89(venv11, vleft11);
AudioConnection          patchCord90(venv11, vright11);
AudioConnection          patchCord91(venv10, vleft10);
AudioConnection          patchCord92(venv10, vright10);
AudioConnection          patchCord93(dright3, 0, vsubmixr3, 1);
AudioConnection          patchCord94(vleft3, 0, vsubmixl3, 0);
AudioConnection          patchCord95(vleft8, 0, vsubmixl8, 0);
AudioConnection          patchCord96(dleft3, 0, vsubmixl3, 1);
AudioConnection          patchCord97(vleft2, 0, vsubmixl2, 0);
AudioConnection          patchCord98(vleft4, 0, vsubmixl4, 0);
AudioConnection          patchCord99(vright3, 0, vsubmixr3, 0);
AudioConnection          patchCord100(dright2, 0, vsubmixr2, 1);
AudioConnection          patchCord101(vleft1, 0, vsubmixl1, 0);
AudioConnection          patchCord102(dright4, 0, vsubmixr4, 1);
AudioConnection          patchCord103(vright2, 0, vsubmixr2, 0);
AudioConnection          patchCord104(vright4, 0, vsubmixr4, 0);
AudioConnection          patchCord105(dleft2, 0, vsubmixl2, 1);
AudioConnection          patchCord106(vright8, 0, vsubmixr8, 0);
AudioConnection          patchCord107(dleft4, 0, vsubmixl4, 1);
AudioConnection          patchCord108(vright1, 0, vsubmixr1, 0);
AudioConnection          patchCord109(vleft5, 0, vsubmixl5, 0);
AudioConnection          patchCord110(vleft7, 0, vsubmixl7, 0);
AudioConnection          patchCord111(dright1, 0, vsubmixr1, 1);
AudioConnection          patchCord112(vright5, 0, vsubmixr5, 0);
AudioConnection          patchCord113(dleft1, 0, vsubmixl1, 1);
AudioConnection          patchCord114(vright7, 0, vsubmixr7, 0);
AudioConnection          patchCord115(vleft6, 0, vsubmixl6, 0);
AudioConnection          patchCord116(vright6, 0, vsubmixr6, 0);
AudioConnection          patchCord117(vleft16, 0, vsubmixl16, 0);
AudioConnection          patchCord118(vright16, 0, vsubmixr16, 0);
AudioConnection          patchCord119(vleft13, 0, vsubmixl13, 0);
AudioConnection          patchCord120(vleft15, 0, vsubmixl15, 0);
AudioConnection          patchCord121(vright13, 0, vsubmixr13, 0);
AudioConnection          patchCord122(vright15, 0, vsubmixr15, 0);
AudioConnection          patchCord123(vleft14, 0, vsubmixl14, 0);
AudioConnection          patchCord124(vright14, 0, vsubmixr14, 0);
AudioConnection          patchCord125(vleft12, 0, vsubmixl12, 0);
AudioConnection          patchCord126(vright12, 0, vsubmixr12, 0);
AudioConnection          patchCord127(vleft9, 0, vsubmixl9, 0);
AudioConnection          patchCord128(vleft11, 0, vsubmixl11, 0);
AudioConnection          patchCord129(vright9, 0, vsubmixr9, 0);
AudioConnection          patchCord130(vright11, 0, vsubmixr11, 0);
AudioConnection          patchCord131(vleft10, 0, vsubmixl10, 0);
AudioConnection          patchCord132(vright10, 0, vsubmixr10, 0);
AudioConnection          patchCord133(vsubmixr4, 0, mixerRight1, 3);
AudioConnection          patchCord134(vsubmixl4, 0, mixerLeft1, 3);
AudioConnection          patchCord135(vsubmixl3, 0, mixerLeft1, 2);
AudioConnection          patchCord136(vsubmixr3, 0, mixerRight1, 2);
AudioConnection          patchCord137(vsubmixl8, 0, mixerLeft2, 3);
AudioConnection          patchCord138(vsubmixr8, 0, mixerRight2, 3);
AudioConnection          patchCord139(vsubmixl1, 0, mixerLeft1, 0);
AudioConnection          patchCord140(vsubmixr1, 0, mixerRight1, 0);
AudioConnection          patchCord141(vsubmixl5, 0, mixerLeft2, 0);
AudioConnection          patchCord142(vsubmixr5, 0, mixerRight2, 0);
AudioConnection          patchCord143(vsubmixl7, 0, mixerLeft2, 2);
AudioConnection          patchCord144(vsubmixl2, 0, mixerLeft1, 1);
AudioConnection          patchCord145(vsubmixr2, 0, mixerRight1, 1);
AudioConnection          patchCord146(vsubmixr7, 0, mixerRight2, 2);
AudioConnection          patchCord147(vsubmixl6, 0, mixerLeft2, 1);
AudioConnection          patchCord148(vsubmixr6, 0, mixerRight2, 1);
AudioConnection          patchCord149(vsubmixl16, 0, mixerLeft4, 3);
AudioConnection          patchCord150(vsubmixr16, 0, mixerRight4, 3);
AudioConnection          patchCord151(vsubmixl13, 0, mixerLeft4, 0);
AudioConnection          patchCord152(vsubmixr13, 0, mixerRight4, 0);
AudioConnection          patchCord153(vsubmixl15, 0, mixerLeft4, 2);
AudioConnection          patchCord154(vsubmixr15, 0, mixerRight4, 2);
AudioConnection          patchCord155(vsubmixl14, 0, mixerLeft4, 1);
AudioConnection          patchCord156(vsubmixr14, 0, mixerRight4, 1);
AudioConnection          patchCord157(vsubmixl12, 0, mixerLeft3, 3);
AudioConnection          patchCord158(vsubmixr12, 0, mixerRight3, 3);
AudioConnection          patchCord159(vsubmixr9, 0, mixerRight3, 0);
AudioConnection          patchCord160(vsubmixl11, 0, mixerLeft3, 2);
AudioConnection          patchCord161(vsubmixr11, 0, mixerRight3, 2);
AudioConnection          patchCord162(vsubmixl10, 0, mixerLeft3, 1);
AudioConnection          patchCord163(vsubmixl9, 0, mixerLeft3, 0);
AudioConnection          patchCord164(vsubmixr10, 0, mixerRight3, 1);
AudioConnection          patchCord165(mixerLeft2, 0, mainMixerLeft, 1);
AudioConnection          patchCord166(mixerRight4, 0, mainMixerRight, 3);
AudioConnection          patchCord167(mixerLeft4, 0, mainMixerLeft, 3);
AudioConnection          patchCord168(mixerRight2, 0, mainMixerRight, 1);
AudioConnection          patchCord169(mixerLeft1, 0, mainMixerLeft, 0);
AudioConnection          patchCord170(mixerRight3, 0, mainMixerRight, 2);
AudioConnection          patchCord171(mixerLeft3, 0, mainMixerLeft, 2);
AudioConnection          patchCord172(mixerRight1, 0, mainMixerRight, 0);
AudioConnection          patchCord173(mainMixerLeft, 0, OutputMixerLeft, 0);
AudioConnection          patchCord174(mainMixerRight, 0, OutputMixerRight, 0);
AudioConnection          patchCord175(i2s2, 0, inputMixerLeft, 0);
AudioConnection          patchCord176(i2s2, 0, peak_left, 0);
AudioConnection          patchCord177(i2s2, 1, inputMixerRight, 0);
AudioConnection          patchCord178(i2s2, 1, peak_right, 0);
AudioConnection          patchCord179(inputMixerLeft, 0, OutputMixerLeft, 1);
AudioConnection          patchCord180(inputMixerRight, 0, OutputMixerRight, 1);
AudioConnection          patchCord181(OutputMixerLeft, 0, i2s1, 0);
AudioConnection          patchCord182(OutputMixerRight, 0, i2s1, 1);
